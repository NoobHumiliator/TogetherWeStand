...
LinkLuaModifier("modifier_amoeba_boss_jump", "creature_ability/round_amoeba/modifier_amoeba_boss_jump", LUA_MODIFIER_MOTION_BOTH)
...
function amoeba_boss_jump_splatter:Splatter()
    if IsServer() then
        ...
        local enemies = FindUnitsInRadius(self:GetCaster():GetTeamNumber(), self:GetCaster():GetOrigin(), self:GetCaster(), self.radius, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES, FIND_ANY_ORDER, false)
