modifier_boss_sand_king_epicenter = class({})

-----------------------------------------------------------------------------

function modifier_boss_sand_king_epicenter:IsHidden()
	return true
end

-----------------------------------------------------------------------------

function modifier_boss_sand_king_epicenter:IsPurgable()
	return false
end
...
function modifier_boss_sand_king_epicenter:OnDestroy()
	if IsServer() then
	end
end
