...
LinkLuaModifier( "modifier_boss_sand_king_caustic_finale", "creature_ability/round_12_2/modifiers/modifier_boss_sand_king_caustic_finale", LUA_MODIFIER_MOTION_NONE )
