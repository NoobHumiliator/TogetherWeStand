...
LinkLuaModifier( "modifier_healing_burrower_suicide_heal", "creature_ability/round_sandking/modifiers/modifier_healing_burrower_suicide_heal", LUA_MODIFIER_MOTION_NONE )
