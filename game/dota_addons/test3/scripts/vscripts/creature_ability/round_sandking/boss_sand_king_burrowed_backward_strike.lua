boss_sand_king_burrowed_backward_strike = class({})

--------------------------------------------------------------------------------

function boss_sand_king_burrowed_backward_strike:OnAbilityPhaseStart()
	if IsServer() then
...
function boss_sand_king_burrowed_backward_strike:OnAbilityPhaseInterrupted()
	if IsServer() then
...
function boss_sand_king_burrowed_backward_strike:GetPlaybackRateOverride()
	return 0.38
end

--------------------------------------------------------------------------------

function boss_sand_king_burrowed_backward_strike:GetCastRange( vLocation, hTarget )
	if IsServer() then
