modifier_boss_sand_king_burrowstrike_end = class ({})

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike_end:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike_end:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike_end:GetPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike_end:OnCreated( kv )
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike_end:OnIntervalThink()
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike_end:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike_end:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
...
function modifier_boss_sand_king_burrowstrike_end:OnDestroy()
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike_end:CheckState()
	if IsServer() then
		local state =
		{
...
function modifier_boss_sand_king_burrowstrike_end:GetModifierDisableTurning( params )
	return 1
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike_end:GetOverrideAnimation( params )
...
function modifier_boss_sand_king_burrowstrike_end:GetActivityTranslationModifiers( params )
