...
function modifier_boss_sand_king_sandstorm:IsHidden()
	return true
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:IsPurgable()
	return false
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:IsAura()
	return true
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:GetModifierAura()
	return "modifier_boss_sand_king_sandstorm_effect"
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:GetAuraRadius()
	return self.sand_storm_radius
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:GetAuraSearchTeam()
	return DOTA_UNIT_TARGET_TEAM_ENEMY
end

-----------------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:GetAuraSearchType()
...
function modifier_boss_sand_king_sandstorm:OnDestroy()
	if IsServer() then
...
function modifier_boss_sand_king_sandstorm:CheckState()
	local state =
	{
...
function modifier_boss_sand_king_sandstorm:DeclareFunctions()
	local funcs =
	{
...
function modifier_boss_sand_king_sandstorm:GetModifierTurnRate_Percentage( params )
	return -self.storm_decreased_turn_rate
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_sandstorm:UpdateHorizontalMotion( me, dt )
	if IsServer() then
		if self.nProjHandle == nil then
...
function modifier_boss_sand_king_sandstorm:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
