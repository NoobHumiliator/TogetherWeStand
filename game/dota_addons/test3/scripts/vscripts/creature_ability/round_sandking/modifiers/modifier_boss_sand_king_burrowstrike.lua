...
function modifier_boss_sand_king_burrowstrike:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike:GetPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrowstrike:OnCreated( kv )
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike:OnDestroy()
	if IsServer() then
		...
		self:GetParent():AddNewModifier( self:GetParent(), self:GetAbility(), "modifier_boss_sand_king_burrowstrike_end", kv )
	end
end
...
function modifier_boss_sand_king_burrowstrike:UpdateHorizontalMotion( me, dt )
	if IsServer() then
...
function modifier_boss_sand_king_burrowstrike:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end
...
function modifier_boss_sand_king_burrowstrike:CheckState()
	local state =
	{
