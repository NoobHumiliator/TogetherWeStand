...
function modifier_boss_sand_king_burrow:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrow:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrow:GetPriority()
	return MODIFIER_PRIORITY_SUPER_ULTRA
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrow:OnCreated( kv )
	if IsServer() then
...
function modifier_boss_sand_king_burrow:CheckState()
	local state =
	{
...
function modifier_boss_sand_king_burrow:GetActivityTranslationModifiers( params )
	return "burrowed"
end

--------------------------------------------------------------------------------

function modifier_boss_sand_king_burrow:GetModifierTurnRate_Percentage( params )
	return -50
end
