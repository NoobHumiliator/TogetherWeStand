modifier_healing_burrower_suicide_heal = class({})

--------------------------------------------------------------

function modifier_healing_burrower_suicide_heal:IsHidden()
	return true
end

--------------------------------------------------------------

function modifier_healing_burrower_suicide_heal:IsPurgable()
	return true
end

--------------------------------------------------------------

function modifier_healing_burrower_suicide_heal:DeclareFunctions()
	local funcs =
	{
...
function modifier_healing_burrower_suicide_heal:OnDeath( params )
	if IsServer() then
