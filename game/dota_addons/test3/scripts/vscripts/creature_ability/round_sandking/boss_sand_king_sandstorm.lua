...
--------------------------------------------------------------------------------
function boss_sand_king_sandstorm:OnAbilityPhaseInterrupted()
    if IsServer() then
...
--------------------------------------------------------------------------------
function boss_sand_king_sandstorm:GetChannelAnimation()
    return ACT_DOTA_OVERRIDE_ABILITY_2
end

--------------------------------------------------------------------------------
function boss_sand_king_sandstorm:GetPlaybackRateOverride()
    return 0.5
end

--------------------------------------------------------------------------------
function boss_sand_king_sandstorm:OnSpellStart()
    if IsServer() then
        ParticleManager:DestroyParticle(self.nPreviewFX, false)
...
--------------------------------------------------------------------------------
function boss_sand_king_sandstorm:OnChannelFinish(bInterrupted)
    if IsServer() then
        for _, Storm in pairs(self.Storms) do
            if Storm ~= nil then
