...
LinkLuaModifier( "modifier_boss_sand_king_burrowstrike", "creature_ability/round_sandking/modifiers/modifier_boss_sand_king_burrowstrike", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_boss_sand_king_burrowstrike_end", "creature_ability/round_sandking/modifiers/modifier_boss_sand_king_burrowstrike_end", LUA_MODIFIER_MOTION_HORIZONTAL )
--------------------------------------------------------------------------------
