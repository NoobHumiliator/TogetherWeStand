...
big_exploding_burrower_big_explosion = class({})

--------------------------------------------------------------------------------

function big_exploding_burrower_big_explosion:OnAbilityPhaseStart()
	if IsServer() then
...
function big_exploding_burrower_big_explosion:OnSpellStart()
	if IsServer() then
		ParticleManager:DestroyParticle( self.nPreviewFX, false )
