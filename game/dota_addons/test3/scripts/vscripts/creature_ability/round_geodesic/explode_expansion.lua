LinkLuaModifier("modifier_explode_expansion_thinker_aura", "creature_ability/round_geodesic/modifier_explode_expansion_thinker_aura", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_explode_expansion_ally_aura", "creature_ability/round_geodesic/modifier_explode_expansion_ally_aura", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_explode_expansion_thinker_aura_effect", "creature_ability/round_geodesic/modifier_explode_expansion_thinker_aura_effect", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_explode_expansion_ally_aura_effect", "creature_ability/round_geodesic/modifier_explode_expansion_ally_aura_effect", LUA_MODIFIER_MOTION_NONE)
