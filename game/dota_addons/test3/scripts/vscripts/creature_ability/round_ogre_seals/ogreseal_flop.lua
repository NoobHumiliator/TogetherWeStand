ogreseal_flop = class({})
LinkLuaModifier("modifier_ogreseal_flop", "creature_ability/round_ogre_seals/modifier_ogreseal_flop", LUA_MODIFIER_MOTION_BOTH)
...
small_ogreseal_flop = class({})

--------------------------------------------------------------------------------
function small_ogreseal_flop:ProcsMagicStick()
    return false
end

--------------------------------------------------------------------------------
function small_ogreseal_flop:OnAbilityPhaseStart()
    if IsServer() then
        self:GetCaster():StartGesture(ACT_DOTA_CAST_ABILITY_2)
    end
...
--------------------------------------------------------------------------------
function small_ogreseal_flop:OnAbilityPhaseInterrupted()
    if IsServer() then
        self:GetCaster():RemoveGesture(ACT_DOTA_CAST_ABILITY_2)
        self:GetCaster():RemoveModifierByName("modifier_techies_suicide_leap_animation")
    end
...
--------------------------------------------------------------------------------
function small_ogreseal_flop:OnSpellStart()
    if IsServer() then
        self.stun_duration = self:GetSpecialValueFor("stun_duration")
...
--------------------------------------------------------------------------------
function small_ogreseal_flop:TryToDamage()
    if IsServer() then
        local radius = self:GetSpecialValueFor("radius")
        local damage = self:GetSpecialValueFor("damage")
        local silence_duration = self:GetSpecialValueFor("silence_duration")
...
boss_ogreseal_flop = class({})

--------------------------------------------------------------------------------
function boss_ogreseal_flop:ProcsMagicStick()
    return false
end

--------------------------------------------------------------------------------
function boss_ogreseal_flop:OnAbilityPhaseStart()
    if IsServer() then
        self:GetCaster():StartGesture(ACT_DOTA_CAST_ABILITY_2)
    end
...
--------------------------------------------------------------------------------
function boss_ogreseal_flop:OnAbilityPhaseInterrupted()
    if IsServer() then
        self:GetCaster():RemoveGesture(ACT_DOTA_CAST_ABILITY_2)
        self:GetCaster():RemoveModifierByName("modifier_techies_suicide_leap_animation")
    end
...
--------------------------------------------------------------------------------
function boss_ogreseal_flop:OnSpellStart()
    if IsServer() then
        self.stun_duration = self:GetSpecialValueFor("stun_duration")
...
--------------------------------------------------------------------------------
function boss_ogreseal_flop:TryToDamage()
    if IsServer() then
        local radius = self:GetSpecialValueFor("radius")
        local damage = self:GetSpecialValueFor("damage")
        local silence_duration = self:GetSpecialValueFor("silence_duration")
