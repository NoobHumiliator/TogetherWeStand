...
creature_burrower_explosion = class({})

--------------------------------------------------------------------------------

function creature_burrower_explosion:OnAbilityPhaseStart()
	if IsServer() then
...
function creature_burrower_explosion:OnAbilityPhaseInterrupted()
	if IsServer() then
...
function creature_burrower_explosion:OnSpellStart()
	if IsServer() then
		ParticleManager:DestroyParticle( self.nPreviewFX, false )
