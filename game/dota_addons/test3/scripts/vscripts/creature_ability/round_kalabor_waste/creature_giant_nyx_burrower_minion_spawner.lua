...
creature_giant_nyx_burrower_minion_spawner = class({})

function creature_giant_nyx_burrower_minion_spawner:OnSpellStart()
	if IsServer() then
...
function creature_giant_nyx_burrower_minion_spawner:CreateMinion()
