...
_G.FADE_BOLT_MINIONS = {
    ...
    {
        szUnitName = "npc_dota_creature_large_elder_titan",
        nPerSpawn = 1,
        nWeight = 1,
    },
}
        ...
        if self.bPickedUpMinions and not self.bThrewMinions and self.nNextTargetFX == nil then
            ...
            if #Heroes > 0 then
                ...
                if HeroTarget ~= nil then
                    ...
                    ParticleManager:SetParticleControl(self.nNextTargetFX, 1, Vector(3, 0, 0))
...
function modifier_rubick_boss_passive:FadeBoltsPhase_Think()
    if IsServer() then
        ...
        if flDist < 100 and self.bHasCastFadeBoltAtLocation == false and self.FadeBoltsAbility:IsCooldownReady() then
