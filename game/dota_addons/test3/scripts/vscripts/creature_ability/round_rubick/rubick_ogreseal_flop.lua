rubick_ogreseal_flop = class({})
LinkLuaModifier("modifier_ogreseal_flop", "creature_ability/round_rubick/modifier_ogreseal_flop", LUA_MODIFIER_MOTION_BOTH)

--------------------------------------------------------------------------------
function rubick_ogreseal_flop:ProcsMagicStick()
    return false
end

--------------------------------------------------------------------------------
function rubick_ogreseal_flop:OnAbilityPhaseStart()
    if IsServer() then
...
--------------------------------------------------------------------------------
function rubick_ogreseal_flop:OnAbilityPhaseInterrupted()
    if IsServer() then
...
--------------------------------------------------------------------------------
function rubick_ogreseal_flop:OnSpellStart()
    if IsServer() then
...
--------------------------------------------------------------------------------
function rubick_ogreseal_flop:TryToDamage()
    if IsServer() then
