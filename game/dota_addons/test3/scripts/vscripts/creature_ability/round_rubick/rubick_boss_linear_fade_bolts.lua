...
LinkLuaModifier("modifier_rubick_boss_linear_fade_bolts", "creature_ability/round_rubick/modifier_rubick_boss_linear_fade_bolts", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_rubick_boss_linear_fade_bolts_debuff", "creature_ability/round_rubick/modifier_rubick_boss_linear_fade_bolts_debuff", LUA_MODIFIER_MOTION_NONE)
