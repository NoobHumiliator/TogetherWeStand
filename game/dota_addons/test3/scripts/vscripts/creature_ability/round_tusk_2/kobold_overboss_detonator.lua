...
LinkLuaModifier("modifier_kobold_overboss_detonator", "creature_ability/round_tusk_2/modifier_kobold_overboss_detonator", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kobold_overboss_detonator_thinker", "creature_ability/round_tusk_2/modifier_kobold_overboss_detonator_thinker", LUA_MODIFIER_MOTION_NONE)
