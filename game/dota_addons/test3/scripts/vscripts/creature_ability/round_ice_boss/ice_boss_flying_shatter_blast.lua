...
LinkLuaModifier("modifier_ice_boss_flying_shatter_blast_thinker", "creature_ability/round_ice_boss/modifier_ice_boss_flying_shatter_blast_thinker", LUA_MODIFIER_MOTION_NONE)
    ...
    if IsServer() then
        ...
        for i, vTargetPos in ipairs(vTargetPositions) do
            ...
            if hThinker ~= nil then
                ...
                ParticleManager:SetParticleControl(nFXIndex, 15, Vector(0, 255, 0))
