...
LinkLuaModifier( "modifier_ice_boss_flying_shatter_blast_thinker", "creature_ability/modifier/modifier_ice_boss_flying_shatter_blast_thinker", LUA_MODIFIER_MOTION_NONE )
