...
LinkLuaModifier("modifier_ice_boss_egg_passive", "creature_ability/round_ice_boss/modifier_ice_boss_egg_passive", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ice_boss_egg_curse_marker", "creature_ability/round_ice_boss/modifier_ice_boss_egg_curse_marker", LUA_MODIFIER_MOTION_NONE)
