...
LinkLuaModifier("modifier_temple_guardian_wrath_thinker", "creature_ability/round_guardians/modifier_temple_guardian_wrath_thinker", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_temple_guardian_immunity", "creature_ability/round_guardians/modifier_temple_guardian_immunity", LUA_MODIFIER_MOTION_NONE)
