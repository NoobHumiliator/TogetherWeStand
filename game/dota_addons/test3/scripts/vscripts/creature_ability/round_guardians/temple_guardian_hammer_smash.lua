temple_guardian_hammer_smash = class({})
LinkLuaModifier("modifier_ogre_tank_melee_smash_thinker", "creature_ability/round_guardians/modifier_ogre_tank_melee_smash_thinker", LUA_MODIFIER_MOTION_NONE)
...
function temple_guardian_hammer_smash:GetPlaybackRateOverride()
    return 0.445 -- was 0.4013 -- Playbackrate ratio should be kept inversely proportional to HammerSmash base_swing_speed
end
