modifier_tinker_creature_techies_suicide_leap = class({})
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:IsStunDebuff()
    return true
end

--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:IsHidden()
    return true
end

--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:IsPurgable()
    return false
end

--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:RemoveOnDeath()
    return false
end

--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:OnCreated(kv)
    if IsServer() then
        ...
        self.flInitialVelocityZ = math.sqrt(2 * flArcDeltaZ * TECHIES_ACCELERATION_Z)

        local flDeltaZ = self.vLastKnownTargetPos.z - self.vStartPosition.z
        local flSqrtDet = math.sqrt(math.max(0, (self.flInitialVelocityZ * self.flInitialVelocityZ) - 2 * TECHIES_ACCELERATION_Z * flDeltaZ))
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:OnDestroy()
    if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:DeclareFunctions()
    local funcs =     {
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:CheckState()
    local state =     {
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:UpdateHorizontalMotion(me, dt)
    if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:UpdateVerticalMotion(me, dt)
    if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:OnHorizontalMotionInterrupted()
    if IsServer() then
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:OnVerticalMotionInterrupted()
    if IsServer() then
        self:Destroy()
    end
end
...
--------------------------------------------------------------------------------
function modifier_tinker_creature_techies_suicide_leap:GetOverrideAnimation(params)
