...
LinkLuaModifier( "modifier_werewolf_howl_aura", "creature_ability/modifier/modifier_werewolf_howl_aura", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_werewolf_howl_aura_effect", "creature_ability/modifier/modifier_werewolf_howl_aura_effect", LUA_MODIFIER_MOTION_NONE )
