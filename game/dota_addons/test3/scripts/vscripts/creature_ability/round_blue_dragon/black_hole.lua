    ...
    if caster:GetHealth() < caster:GetMaxHealth() * 0.8 and caster:GetHealth() > caster:GetMaxHealth() * 0.5 and caster.fly_switch == 0 then
        ...
        Timers:CreateTimer({
            ...
            callback = function()
                ...
                local enemies = FindUnitsInRadius(DOTA_TEAM_BADGUYS, black_hole_vector, nil, -1, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES, FIND_ANY_ORDER, false)
