...
LinkLuaModifier("modifier_invoker_dark_moon_ghost_walk", "creature_ability/round_invoker/modifier_invoker_dark_moon_ghost_walk", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_invoker_dark_moon_ghost_walk_debuff", "creature_ability/round_invoker/modifier_invoker_dark_moon_ghost_walk_debuff", LUA_MODIFIER_MOTION_NONE)
--------------------------------------------------------------------------------
