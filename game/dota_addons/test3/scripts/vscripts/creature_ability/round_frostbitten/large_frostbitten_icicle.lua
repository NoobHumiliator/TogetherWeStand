...
LinkLuaModifier("modifier_large_frostbitten_icicle", "creature_ability/round_frostbitten/modifier_large_frostbitten_icicle", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_large_frostbitten_icicle_thinker", "creature_ability/round_frostbitten/modifier_large_frostbitten_icicle_thinker", LUA_MODIFIER_MOTION_NONE)
