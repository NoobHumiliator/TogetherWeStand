...
LinkLuaModifier("modifier_lycan_boss_shapeshift_transform", "creature_ability/round_wolf/modifier_lycan_boss_shapeshift_transform", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lycan_boss_shapeshift", "creature_ability/round_wolf/modifier_lycan_boss_shapeshift", LUA_MODIFIER_MOTION_NONE)
