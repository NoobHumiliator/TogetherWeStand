...
LinkLuaModifier("modifier_storegga_spawn_children_thinker", "creature_ability/round_elder_titan/modifier_storegga_spawn_children_thinker", LUA_MODIFIER_MOTION_NONE)
