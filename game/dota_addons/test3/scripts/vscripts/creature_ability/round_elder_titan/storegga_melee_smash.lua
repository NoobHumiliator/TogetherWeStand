...
LinkLuaModifier("modifier_storegga_melee_smash_thinker", "creature_ability/round_elder_titan/modifier_storegga_melee_smash_thinker", LUA_MODIFIER_MOTION_NONE)
