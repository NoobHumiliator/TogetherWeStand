modifier_shredder_chakram_lua_thinker = class({})
local MODE_LAUNCH = 0
local MODE_STAY = 1
local MODE_RETURN = 2
...
--------------------------------------------------------------------------------
-- Classifications
function modifier_shredder_chakram_lua_thinker:IsHidden()
    return true
end

function modifier_shredder_chakram_lua_thinker:IsPurgable()
    return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_shredder_chakram_lua_thinker:OnCreated(kv)
    ...
    "modifier_shredder_chakram_lua_disarm", -- modifier name
    {} -- kv
    )
...
function modifier_shredder_chakram_lua_thinker:OnRemoved()
end

function modifier_shredder_chakram_lua_thinker:OnDestroy()
    if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_shredder_chakram_lua_thinker:OnIntervalThink()
    -- check mode
...
function modifier_shredder_chakram_lua_thinker:LaunchThink()
...
function modifier_shredder_chakram_lua_thinker:StayThink()
    local origin = self.parent:GetOrigin()
    ...
    for _, enemy in pairs(enemies) do
        ...
        enemy:AddNewModifier(
        	self.caster, -- player source
        	self:GetAbility(), -- ability source
        	"modifier_shredder_chakram_lua", -- modifier name
...
function modifier_shredder_chakram_lua_thinker:ReturnThink()
    local origin = self.parent:GetOrigin()
...
function modifier_shredder_chakram_lua_thinker:PassLogic(origin)
    -- find enemies
    local enemies = FindUnitsInRadius(
    self.caster:GetTeamNumber(), -- int, your team number
    origin, -- point, center point
...
function modifier_shredder_chakram_lua_thinker:MoveLogic(origin)
    -- move position
...
function modifier_shredder_chakram_lua_thinker:ReturnChakram()
...
--------------------------------------------------------------------------------
-- Aura Effects
function modifier_shredder_chakram_lua_thinker:IsAura()
    return self.mode == MODE_STAY
end

function modifier_shredder_chakram_lua_thinker:GetModifierAura()
    return "modifier_shredder_chakram_lua_debuff"
end

function modifier_shredder_chakram_lua_thinker:GetAuraRadius()
    return self.radius
end

function modifier_shredder_chakram_lua_thinker:GetAuraDuration()
    return 0.3
end

function modifier_shredder_chakram_lua_thinker:GetAuraSearchTeam()
    return DOTA_UNIT_TARGET_TEAM_ENEMY
end

function modifier_shredder_chakram_lua_thinker:GetAuraSearchType()
    return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

function modifier_shredder_chakram_lua_thinker:GetAuraSearchFlags()
    return DOTA_UNIT_TARGET_FLAG_NONE
end

--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_shredder_chakram_lua_thinker:PlayEffects1()
    -- Get Resources
...
function modifier_shredder_chakram_lua_thinker:PlayEffects2()
...
function modifier_shredder_chakram_lua_thinker:PlayEffects3()
    -- destroy previous particle
    ParticleManager:DestroyParticle(self.effect_cast, false)
    ParticleManager:ReleaseParticleIndex(self.effect_cast)
...
function modifier_shredder_chakram_lua_thinker:StopEffects()
    -- destroy previous particle
    ParticleManager:DestroyParticle(self.effect_cast, false)
    ParticleManager:ReleaseParticleIndex(self.effect_cast)
...
-- function modifier_shredder_chakram_lua_thinker:PlayEffects()
--     -- Get Resources
