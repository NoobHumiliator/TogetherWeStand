LinkLuaModifier( "modifier_doom_bringer_devour_datadriven", "heroes/hero_faceless_void/modifier_doom_bringer_devour_datadriven", LUA_MODIFIER_MOTION_NONE )
...
function doom_bringer_devour_datadriven:OnSpellStart()
    ...
    local devour_time = self:GetAbility():GetSpecialValueFor("devour_time")
