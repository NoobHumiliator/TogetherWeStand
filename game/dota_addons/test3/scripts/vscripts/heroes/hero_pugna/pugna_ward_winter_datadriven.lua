...
pugna_ward_winter_datadriven = class({})
LinkLuaModifier( "modifier_pugna_ward_winter", "heroes/hero_pugna/modifier_pugna_ward_winter", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_pugna_ward_winter_effect", "heroes/hero_pugna/modifier_pugna_ward_winter_effect", LUA_MODIFIER_MOTION_NONE )

-----------------------------------------------------------------------------------------

function pugna_ward_winter_datadriven:ProcsMagicStick()
	return false
end

--------------------------------------------------------------------------------

function pugna_ward_winter_datadriven:OnSpellStart()
	if IsServer() then
