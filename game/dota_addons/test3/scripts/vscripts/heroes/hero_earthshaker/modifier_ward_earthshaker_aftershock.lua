...
function modifier_ward_earthshaker_aftershock:OnCreated(kv)
    self.afterShockAbility = self:GetAbility():GetCaster():FindAbilityByName("earthshaker_aftershock_lua")
end
...
function modifier_ward_earthshaker_aftershock:OnSpentMana(params)
    if IsServer() then
        ...
        if self:GetAbility() ~= nil and self:GetAbility():GetCaster() ~= nil and self:GetAbility():GetCaster():FindAbilityByName("earthshaker_aftershock_lua") then
            local ability = self:GetAbility():GetCaster():FindAbilityByName("earthshaker_aftershock_lua")
