...
function modifier_queenofpain_shadow_strike_lua:OnRemoved()
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_queenofpain_shadow_strike_lua:CheckState()
    local state = {
...
--------------------------------------------------------------------------------
-- Graphics & Animations
-- function modifier_queenofpain_shadow_strike_lua:GetEffectName()
-- 	return "particles/units/heroes/hero_queenofpain/queen_shadow_strike_debuff.vpcf"
-- end
-- function modifier_queenofpain_shadow_strike_lua:GetEffectAttachType()
-- 	return PATTACH_ABSORIGIN_FOLLOW
-- end
function modifier_queenofpain_shadow_strike_lua:PlayEffects()
