drow_ranger_trueshot_lua_level_2 = class({})
...
function drow_ranger_trueshot_lua_level_2:GetIntrinsicModifierName()
	return "modifier_drow_ranger_trueshot_lua_aura"
end

--------------------------------------------------------------------------------
function drow_ranger_trueshot_lua_level_2:OnSpellStart()
	if IsServer() then
