drow_ranger_trueshot_lua_level_3 = class({})
...
function drow_ranger_trueshot_lua_level_3:GetIntrinsicModifierName()
	return "modifier_drow_ranger_trueshot_lua_aura"
end

--------------------------------------------------------------------------------
function drow_ranger_trueshot_lua_level_3:OnSpellStart()
	if IsServer() then
