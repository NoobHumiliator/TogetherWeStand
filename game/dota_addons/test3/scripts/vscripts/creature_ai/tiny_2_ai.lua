...
function Spawn( entityKeyValues )
    ...
    behaviorSystem = AICore:CreateBehaviorSystem( { BehaviorNone , BehaviorHold , BehaviorFreeze ,BehaviorEvolve ,BehaviorStrike} ) 
end
...
function BehaviorEvolve:Evaluate()
	local desire = 1
	if currentBehavior == self then return desire end
	self.plasmaAbility = thisEntity:FindAbilityByName( "tiny_growto_3" )                          
    if thisEntity:GetHealth()>10500 and self.plasmaAbility and self.plasmaAbility:IsFullyCastable() then
          desire=15
    end 
    return desire
end
...
--------------------------------------------------------------------------------------------------------
AICore.possibleBehaviors = { BehaviorNone , BehaviorHold , BehaviorFreeze ,BehaviorEvolve,BehaviorStrike}
