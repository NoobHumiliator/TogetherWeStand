...
function BehaviorStatic_Link:Evaluate()
	self.staticlinkAbility = thisEntity:FindAbilityByName("dark_twin_dark_debuff_datadriven")    --¶Ô¼¼ÄÜ½øÐÐ¶¨Òå
	local target
	local desire = 0
	...
	if self.staticlinkAbility and self.staticlinkAbility:IsFullyCastable() then   --¼¼ÄÜ´æÔÚ¶øÇÒ´¦ÓÚCDÖÐÓÐÀ¶
