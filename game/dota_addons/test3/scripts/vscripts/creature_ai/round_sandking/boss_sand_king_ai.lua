...
function Spawn( entityKeyValues )
	if IsServer() then
		...
		TailSwipeLeft = thisEntity:FindAbilityByName( "boss_sand_king_tail_swipe_left" )
		TailSwipeRight = thisEntity:FindAbilityByName( "boss_sand_king_tail_swipe_right" )
		BurrowStrike = thisEntity:FindAbilityByName( "boss_sand_king_burrowstrike" )
		BurrowDown = thisEntity:FindAbilityByName( "boss_sand_king_burrow" )
		BurrowUp = thisEntity:FindAbilityByName( "boss_sand_king_unburrow" )
		SandStorm = thisEntity:FindAbilityByName( "boss_sand_king_sandstorm" )
		Epicenter = thisEntity:FindAbilityByName( "boss_sand_king_epicenter" )
		ForwardTailSwipe = thisEntity:FindAbilityByName( "boss_sand_king_burrowed_forward_strike" )
		BackwardsTailSwipe = thisEntity:FindAbilityByName( "boss_sand_king_burrowed_backward_strike" )

		DirectionalMoveLeft = thisEntity:FindAbilityByName( "boss_sand_king_move_left" )
		DirectionalMoveRight = thisEntity:FindAbilityByName( "boss_sand_king_move_right" )
		DirectionalMoveBack = thisEntity:FindAbilityByName( "boss_sand_king_move_back" )
...
function ChangePhase()
	...
	return true
	--local nHealthPct = thisEntity:GetHealthPercent()
--	if ( nHealthPct < SANDSTORM_HP_PCT ) and ( nHealthPct > EPICENTER_HP_PCT ) and ( thisEntity.PHASE < PHASE_SANDSTORM ) then
--		thisEntity.PHASE = PHASE_SANDSTORM
--		return true
--	elseif ( nHealthPct < EPICENTER_HP_PCT ) and ( thisEntity.PHASE < PHASE_EPICENTER ) then
--		thisEntity.PHASE = PHASE_EPICENTER
--		return true
--	end
--	return false
