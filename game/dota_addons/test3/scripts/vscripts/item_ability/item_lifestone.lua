...
LinkLuaModifier("modifier_item_lifestone", "item_ability/modifier/modifier_item_lifestone", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_lifestone_pact", "item_ability/modifier/modifier_item_lifestone_pact", LUA_MODIFIER_MOTION_NONE)
