...
LinkLuaModifier("modifier_item_glimmerdark_shield", "item_ability/modifier/modifier_item_glimmerdark_shield", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_glimmerdark_shield_prism", "item_ability/modifier/modifier_item_glimmerdark_shield_prism", LUA_MODIFIER_MOTION_NONE)
