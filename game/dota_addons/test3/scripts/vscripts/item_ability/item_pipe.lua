FirstLevelAuraMap = {
    ...
    drow_ranger_trueshot_lua = "drow_ranger_trueshot_lua_level_2",
    lycan_feral_impulse = "lycan_feral_impulse_level_2",
    rubick_null_field = "rubick_null_field_level_2",
    necrolyte_heartstopper_aura_lua = "necrolyte_heartstopper_aura_level_2_lua",
...
SecondLevelAuraMap = {
    ...
    drow_ranger_trueshot_lua_level_2 = "drow_ranger_trueshot_lua_level_3",
    lycan_feral_impulse_level_2 = "lycan_feral_impulse_level_3",
    rubick_null_field_level_2 = "rubick_null_field_level_3",
    necrolyte_heartstopper_aura_level_2_lua = "necrolyte_heartstopper_aura_level_3_lua",
